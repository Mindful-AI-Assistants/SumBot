...
**SumBot FreeCode** is an AI-powered chatbot integrated with **GPT-3.5 Turbo**, developed as a real-use project by **Fabiana Campanari** for the **Ready [Tensor AI Hackathon 2024](https://app.readytensor.ai/)**. This chatbot simplifies communication by summarizing long messages into concise information, streamlining productivity in various settings.
